package com.birth.forumhub.modules.user.controller;
import com.birth.forumhub.modules.user.controller.dto.UserResponseDTO;
import com.birth.forumhub.modules.user.controller.dto.UserUpdateRequestDTO;
import com.birth.forumhub.modules.user.usecase.*;
...
public class UserController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "User marked as high successfully"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "404", description = "User not found"),
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "User unmarked as high successfully"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "404", description = "User not found"),
    })
